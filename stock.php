				...
				<div class="card">
					...
					<div class="card-body">
						<div class="table-responsive">
							<a href="index.php?page=stock.php&option=add"><button class="btn btn-primary">Add Stock</button></a><br><br>
							<table id="basic-datatables" class="display table table-striped table-hover">
								...
								<tbody>
									<?php
									$sql_view="SELECT purchase_id,product_id,quantity FROM stock";
