...
{
	$sql_lastprice = "SELECT startdate FROM productprice WHERE product_id='$_POST[txtproductid]' ORDER BY startdate DESC LIMIT 1";
	...
	if($row_lastprice["startdate"]==date("Y-m-d")){
		$sql_delete="DELETE FROM productprice  WHERE product_id='$_POST[txtproductid]' AND startdate='$row_lastprice[startdate]'";
...
{
	$sql_lastprice = "SELECT startdate FROM productprice WHERE product_id='$_POST[txtproductid]' AND enddate IS NULL";
	$result_lastprice=mysqli_query($con,$sql_lastprice) or die("sql error in sql_lastprice".mysqli_error($con));
	$row_lastprice=mysqli_fetch_assoc($result_lastprice);
	...
	if($row_lastprice["startdate"]==date("Y-m-d")){
		...
		$sql_delete="UPDATE  productprice SET enddate='$yesterday'  WHERE product_id='$_POST[txtproductid]' AND startdate='$row_lastprice[startdate]'";
		$result_delete=mysqli_query($con,$sql_delete) or die("sql error in sql_delete".mysqli_error($con));
	}
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">									
											...
											<font color="red"> *Offer must be in percentage %</font>
										</div>
										<!-- column two end -->
									</div>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-6 col-lg-12">	
											<center>
												<a href="index.php?page=product.php&option=fullview&pk_product_id=<?php echo $get_pk_product_id; ?>"><input type="button" class="btn btn-primary" name="btngoback" id="btngoback"  value="Go Back"/></a>
							...
							<form method="POST" action="">
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-6 col-lg-12">	
											<center>
												<a href="index.php?page=product.php&option=fullview&pk_product_id=<?php echo $row_edit["product_id"]; ?>"><input type="button" class="btn btn-primary" name="btngoback" id="btngoback"  value="Go Back"/></a>
