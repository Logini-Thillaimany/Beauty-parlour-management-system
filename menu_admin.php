...
$sql_pending_leave="SELECT leave_id,staff_id,startdate,enddate,status FROM staffleave WHERE status='Pending' ORDER BY startdate DESC";
$result_pending_leave=mysqli_query($con,$sql_pending_leave) or die("sql error in sql_pending_leave ".mysqli_error($con));
$pending_leave_notification=mysqli_num_rows($result_pending_leave);

$total_notification+=$pending_leave_notification;

// Fetch upcoming leave notifications
$today = date("Y-m-d");
$upcoming_leave_notification=0;
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="tables">
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="index.php?page=notification_new_leave.php">
                        <span class="sub-item">New Leave Application(<?php echo $pending_leave_notification; ?>)</span>
                      </a>
                    </li> 
                    <li>
