...
{
	$sql_insert="INSERT INTO supplier(supplier_id,name,mobile,address,email)
...
if(isset($_GET["option"]))
{
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">									
											...
											<input type="text" class="form-control" onblur="emailvalidation()" name="txtemail" id="txtemail" required placeholder="your E-mail"/>
										</div>
										<!-- column one end -->
										<!-- column two start -->
										<div class="col-md-6 col-lg-6">
					...
					<div class="card-body">
						<div class="table-responsive">
							...
							<table id="basic-datatables" class="display table table-striped table-hover">
								...
								<tbody>
									<?php
									$sql_view="SELECT supplier_id,name,mobile,address,email FROM supplier";
							...
							<form method="POST" action="">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">									
											<label for="txtemail">E-mail</label>
											<input type="text" class="form-control" onblur="emailvalidation()" name="txtemail" id="txtemail" required placeholder="your E-mail"  value="<?php echo $row_edit["email"]; ?>"/>
										</div>
										<!-- column one end -->
										<!-- column two start -->
										<div class="col-md-6 col-lg-6">
											<label for="txtmobile">Mobile</label>
											<input type="text" class="form-control" onkeypress="return isNumberKey(event)" onblur="phonenumber('txtmobile')"  name="txtmobile" id="txtmobile" required placeholder="your Mobile" value="<?php echo $row_edit["mobile"]; ?>" />
										</div>
										<!-- column two end -->
									</div>
								</div>
	...
	else if($_GET["option"]=="delete")
	{
		...
		$sql_delete=" DELETE FROM supplier WHERE supplier_id='$get_pk_supplier_id'";
