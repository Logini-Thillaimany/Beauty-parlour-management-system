...
if(isset($_POST["btnsave"]))
{
	...
	if($result_insert)
	{
		echo '<script>alert("Successfully Insert");
						window.location.href="index.php?page=packageproduct.php&option=add";</script>';
	}
}
//insert code end
...
if(isset($_GET["option"]))
{
	...
	else if($_GET["option"]=="delete")
	{
		...
		$sql_delete="DELETE FROM packageproduct WHERE package_id='$get_pk_package_id' AND product_id='$get_pk_product_id'";
